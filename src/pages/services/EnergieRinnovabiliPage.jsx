...
export default function EnergieRinnovabiliPage({ setCurrentPage }) {
    const features = [
        {
    ...
    return (
        <div className="overflow-hidden bg-white dark:bg-slate-950">
            ...
            <section className="py-24 bg-slate-900 relative overflow-hidden">
                <div className="absolute inset-0 bg-[url('/solar-panels.png')] bg-cover bg-center opacity-10 mix-blend-overlay" />
